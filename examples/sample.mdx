...
# Spans
**Spans** are created by surrounding elements in `$` symbols. They can be useful for adding some { .class=rainbow }
$ style $ to in-line text.
...
###### Example
^^
<pre style="display: inline"><</pre>https://ko-fi.com/mattbourke>
[Buy me a coffee (please)](https://ko-fi.com/mattbourke)
^^

{ .class=example-output } [
	{ .class=example-tag } Produces

	<https://ko-fi.com/mattbourke>
	[Buy me a coffee (please)](https://ko-fi.com/mattbourke)
]
...
# Code
**Code** components are inline versions of code, which are enclosed by backticks
{ .style=color:red } $ (need backslash working to display backtick in a code component) $.
